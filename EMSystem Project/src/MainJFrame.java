...
public class MainJFrame extends javax.swing.JFrame {
	...
	private static int selectedEmployeeNumber = -1;	// the currently selected employee number
	
	// flags for when certain listeners, methods, or other sections of code should be active
	private static boolean locIsOK = true;	// flag for whether changing location should be attempted
	private static boolean sexIsOK = true;	// flag for whether changing sex should be attempted
	
	private static boolean saveable = false;	// flag for whether saving should be attempted
	private static boolean changeType = false;	// flag for when an employee is changing type
	...
	public MainJFrame() {
		...
		initComponents();	// autogenerated method for initializing the jFrame
		jComboBox1.setSelectedItem(settings.getLookAndFeel());	// set the selected look and feel in the drop down menu
		initEmployeeJTable();	// call method for initializing the employee table display
		jTable1.setAutoCreateRowSorter(true);	// enable sorting of the employee table
		resetLocList();	// set the list of locations in the edit locations window
